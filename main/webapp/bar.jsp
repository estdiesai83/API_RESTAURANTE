...
<div style="margin-left: 25%; padding: 1px; height:700px;">
	<br><br>
	<img alt="" src="img/bar.jpeg" style="width:200px; height: 150px; margin-left: 450px">
	
	<div style="background-color: rgb(215,215,215); padding: 20px;">
		<div style="margin-left: 10px ;">
			<a href="bar/ventas.jsp">
